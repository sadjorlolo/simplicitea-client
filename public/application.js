...
var config = {
  apiOrigins: {
    production: 'https://desolate-depths-48909.herokuapp.com',
...
var signOutHide = function signOutHide() {
  $('.see-reviews').hide();
  $('.create-review').hide();
...
var createClick = function createClick() {
  $('.see-reviews-content').html('');
  $('.see-review-content').html('');
  $('.delete-review-msg').html('');
  $('.update-review-content').html('');
...
var seeReviewsClick = function seeReviewsClick() {
  $('.see-review-content').html('');
  $('.delete-review-msg').html('');
  $('.update-review-content').html('');
  $('.see-teas').html('');
...
module.exports = {
  ...
  seeReviewsClick: seeReviewsClick
};
...
var reviewShowhide = __webpack_require__(6);
...
var reviewEvents = __webpack_require__(19);
...
var showhide = __webpack_require__(9);
...
var teaApi = __webpack_require__(41);
var teaUi = __webpack_require__(42);
...
var onGetReviews = function onGetReviews(event) {
  ...
  event.preventDefault();
  api.index().then(ui.getReviewsSuccess).catch(ui.getReviewsError);
};

var onCancelView = function onCancelView(event) {
  $('.pswd-msg-box').text('');
  $('.see-reviews-content').html('');
  $('.create-review').show();
  $('.see-reviews').show();
...
var onGetReview = function onGetReview(event) {
  $('.pswd-msg-box').text('');
  event.preventDefault();
  var selectedReviewId = $(this).parent().attr('data-id');
  api.show(selectedReviewId).then(ui.getReviewSuccess).catch(ui.getReviewError);
};
...
var onDeleteReview = function onDeleteReview(event) {
  ...
  $('.see-reviews').show();
  event.preventDefault();
  var reviewForDelete = $(this).parent().attr('data-id');
  api.destroy(reviewForDelete).then(ui.deleteReviewSuccess).catch(ui.deleteReviewError);
};
...
var onEditReview = function onEditReview(event) {
  ...
  $('.new-created').text('');
  event.preventDefault();
  var reviewForEdit = $(this).parent().attr('data-id');
  api.show(reviewForEdit).then(ui.editReviewSuccess).catch(ui.editReviewError);
};

var onCloseReview = function onCloseReview(event) {
  $('.pswd-msg-box').text('');
  $('.new-update').text('');
  $('.new-created').text('');
  event.preventDefault();
...
var onUpdateReview = function onUpdateReview(event) {
  ...
  event.preventDefault();
  var data = getFormFields(this);
  api.update(data).then(ui.updateReviewSuccess).catch(ui.updateReviewError);
};
...
var onGetTeas = function onGetTeas(event) {
  $('.pswd-msg-box').text('');
  $('.create-review').hide();
  $('.see-reviews').hide();
  $('.update-error-msg').hide();
  event.preventDefault();
  teaApi.index().then(teaUi.getTeasSuccess).catch(teaUi.getTeasError);
};

var onCancelCreate = function onCancelCreate(event) {
  $('.pswd-msg-box').text('');
  event.preventDefault();
  $('.see-teas').html('');
  $('.create-review').show();
...
var onCancelReview = function onCancelReview(event) {
  $('.pswd-msg-box').text('');
  event.preventDefault();
  $('.show-tea').html('');
  $('.create-review').show();
...
var onSelectTea = function onSelectTea(event) {
  $('.pswd-msg-box').text('');
  event.preventDefault();
  $('.see-teas').html('');
  var selectedTeaId = $(this).parent().attr('data-id');
  teaApi.show(selectedTeaId).then(teaUi.getTeaSuccess).catch(teaUi.getTeaError);
};
...
var onSubmitReview = function onSubmitReview(event) {
  ...
  var data = getFormFields(this);
  event.preventDefault();
  api.create(data).then(ui.createReviewSuccess).catch(ui.createReviewError);
};
...
var store = __webpack_require__(2);
var showhide = __webpack_require__(6);
var showReviewsTemplate = __webpack_require__(22);
var showReviewTemplate = __webpack_require__(39);
var editReviewTemplate = __webpack_require__(40);

var getReviewsSuccess = function getReviewsSuccess(data) {
  showhide.seeReviewsClick();
  store.reviews = data.reviews;
  var showReviewsHTML = showReviewsTemplate({ reviews: store.reviews });
  $('.see-reviews-content').html(showReviewsHTML);
};

var getReviewsError = function getReviewsError() {
  $('.see-reviews-content').text('Sorry, review retrieval did not work.');
};

var insertCuppa = function insertCuppa(rating) {
  for (var i = 0; i < rating; i++) {
    $('.cuppa').append("<img src='https://raw.githubusercontent.com/sadjorlolo/simplicitea-client/cuppa/images/cuppa.png'>");
  }
};

var getReviewSuccess = function getReviewSuccess(data) {
  $('.see-reviews-content').html('');
  var showReviewHTML = showReviewTemplate(data.review);
  $('.see-review-content').html(showReviewHTML);
  insertCuppa(data.review.rating);
};

var createReviewSuccess = function createReviewSuccess(data) {
  $('.show-tea').html('');
  getReviewSuccess(data);
  $('.new-created').text('Your review was created successfully!');
};

var createReviewError = function createReviewError(data) {
...
var editReviewSuccess = function editReviewSuccess(data) {
  $('.see-review-content').html('');
  var editReviewHTML = editReviewTemplate(data.review);
...
var editReviewError = function editReviewError() {
...
var updateReviewSuccess = function updateReviewSuccess(data) {
  $('.update-review-content').html('');
  $('.new-update').text('Your review has been updated.');
  getReviewSuccess(data);
};

var updateReviewError = function updateReviewError() {
  $('.update-review-content').html('');
...
var deleteReviewError = function deleteReviewError() {
  $('.delete-review-msg').text('');
  $('.delete-review-msg').show();
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.reviews : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "\n <div class='see-review' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <h4>Name: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.tea : stack1)) != null ? stack1.name : stack1), depth0))
    + "</h4>\n  <h4>Brand: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.tea : stack1)) != null ? stack1.brand : stack1), depth0))
    + "</h4>\n  <h4>Type: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.tea : stack1)) != null ? stack1.tea_type : stack1), depth0))
    + "</h4>\n  <h4>Packaging: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.tea : stack1)) != null ? stack1.packaging : stack1), depth0))
    + "</h4>\n  <h4>Water Temperature: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.water_temp : stack1), depth0))
    + "</h4>\n  <h4>Steep Time (in minutes): "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.steep_time : stack1), depth0))
    + "</h4>\n  <h4>Rating: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
    + "</h4>\n  <h4>Notes:</h4>\n  <h4 class='view-review-notes'>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </h4>\n  <button class='view-review' type='click'>View</button>\n</div>\n\n";
  ...
  return "      "
    ...
    return "<div class='no-reviews'>Hmm. Looks like you don't have any reviews yet.</div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<div class='close-reviews-button'>\n  <button class='close-view-reviews' type='click'>Close reviews</button>\n</div>\n\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.reviews : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(7, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n <div class='this-review' data-id=\""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\">\n  <h4>Name: "
    + alias4(alias5(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h4>\n  <h4>Brand: "
    + alias4(alias5(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.brand : stack1), depth0))
    + "</h4>\n  <h4>Type: "
    + alias4(alias5(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.tea_type : stack1), depth0))
    + "</h4>\n  <h4>Packaging: "
    + alias4(alias5(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.packaging : stack1), depth0))
    + "</h4>\n  <h4>Water Temperature: "
    + alias4(((helper = (helper = helpers.water_temp || (depth0 != null ? depth0.water_temp : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"water_temp","hash":{},"data":data}) : helper)))
    + "</h4>\n  <h4>Steep Time (in minutes): "
    + alias4(((helper = (helper = helpers.steep_time || (depth0 != null ? depth0.steep_time : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"steep_time","hash":{},"data":data}) : helper)))
    + "</h4>\n  <div class='cuppa'><span>Rating:</span> </div>\n  <h4>Notes:</h4>\n  <h4 class='view-review-notes'>\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.notes : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "  </h4>\n\n  <button class='delete-review' type='click'>Delete this Review</button>\n  <button class='edit-review' type='click'>Edit this Review</button>\n  <button class='close-view' type='click'>Close</button>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class='selected-review' data-id=\""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\">\n <h4>Name: "
    + alias4(alias5(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h4>\n <h4>Brand: "
    ...
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\">\n     <input type='hidden' name='review[tea_id]' value =\""
    + alias4(alias5(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n     <h4> Water Temperature:\n     <select class='water-temp' id='edit-review-water-temp' name='review[water_temp]'>\n       <option value='Hot'>Hot</option>\n       <option value='Iced'>Iced</option>\n     </select>\n     </h4>\n     <h4> Steep Time (in minutes):\n       <input type='text' class='steep-time' name='review[steep_time]' value=\""
    + alias4(((helper = (helper = helpers.steep_time || (depth0 != null ? depth0.steep_time : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"steep_time","hash":{},"data":data}) : helper)))
    + "\">\n     </h4>\n     <h4> Rating:\n       <select class='rating' id='edit-review-rating' name='review[rating]'>\n         <option value='1'>1</option>\n         <option value='2'>2</option>\n         <option value='3'>3</option>\n         <option value='4'>4</option>\n         <option value='5'>5</option>\n       </select>\n     </h4>\n     <h4>Notes: </h4>\n     <textarea cols='32' wrap='soft' rows='3' class='notes' name='review[notes]'>"
    + alias4(((helper = (helper = helpers.notes || (depth0 != null ? depth0.notes : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"notes","hash":{},"data":data}) : helper)))
    + "</textarea>\n     <input type='submit' class='update-input-button' name='submit' value='Update Review'>\n   </fieldset>\n </form>\n <button type='click' class='cancel-update'>Cancel</button>\n\n\n</div>\n";
},"useData":true});
...
var store = __webpack_require__(2);
var showhide = __webpack_require__(6);
var showTeasTemplate = __webpack_require__(43);
var showTeaTemplate = __webpack_require__(44);

var getTeasSuccess = function getTeasSuccess(data) {
  showhide.createClick();
  store.teas = data.teas;
  var showTeasHTML = showTeasTemplate({ teas: store.teas });
  $('.see-teas').html(showTeasHTML);
};

var getTeasError = function getTeasError() {
  $('.see-reviews-content').text('Sorry, tea retrieval did not work.');
};

var getTeaSuccess = function getTeaSuccess(data) {
  showhide.createClick();
  var showTeaHTML = showTeaTemplate({ tea: data.tea });
  $('.show-tea').html(showTeaHTML);
};

var getTeaError = function getTeaError() {
  $('.see-reviews-content').text('Sorry, selected tea retrieval did not work.');
};

module.exports = {
  getTeasSuccess: getTeasSuccess,
  getTeasError: getTeasError,
  getTeaSuccess: getTeaSuccess,
  getTeaError: getTeaError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n <div class='see-tea' data-id=\""
    ...
    + "</h4>\n  <h4>Type: "
    + alias4(((helper = (helper = helpers.tea_type || (depth0 != null ? depth0.tea_type : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"tea_type","hash":{},"data":data}) : helper)))
    + "</h4>\n  <h4>Packaging: "
    + alias4(((helper = (helper = helpers.packaging || (depth0 != null ? depth0.packaging : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"packaging","hash":{},"data":data}) : helper)))
    + "</h4>\n\n  <button class='select-tea' type='click'>Select</button>\n</div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "<div class='close-select-tea-button'>\n  <button class='cancel-create' type='click'>Cancel</button>\n</div>\n<h3 class='instructions'>First, please select a tea to review.</h3>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.teas : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1),"inverse":container.noop,"data":data})) != null ? stack1 : "");
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class='selected-tea' data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n <h4>Name: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h4>\n <h4>Brand: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.brand : stack1), depth0))
    + "</h4>\n <h4>Type: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.tea_type : stack1), depth0))
    + "</h4>\n <h4>Packaging: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.packaging : stack1), depth0))
    + "</h4>\n\n <form class='new-review'>\n   <fieldset>\n     <input type='hidden' name='review[tea_id]' value =\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n     <h4>Water Temperature:\n       <select class='water-temp' name='review[water_temp]'>\n         <option value='Hot'>Hot</option>\n         <option value='Iced'>Iced</option>\n       </select>\n    </h4>\n    <h4> Steep Time (in minutes):\n      <input type='text' class='steep-time' name='review[steep_time]'>\n    </h4>\n    <h4>Rating:\n       <select class='rating' name='review[rating]'>\n         <option value='1'>1</option>\n         <option value='2'>2</option>\n         <option value='3'>3</option>\n         <option value='4'>4</option>\n         <option value='5'>5</option>\n       </select>\n     </h4>\n     <h4>Notes: <br>\n       <textarea cols='32' wrap='soft' rows='3' class='notes' name='review[notes]' placeholder='any sugar? milk? cream?'></textarea>\n     </h4>\n     <input type='submit' class='new-review-button' name='submit' value='Submit Review'>\n     <button type='click' class='cancel-review'>Cancel</button>\n   </fieldset>\n </form>\n\n</div>\n";
},"useData":true});
